...
const baseUrl = 'http://182.92.128.70:8081'; // 新服务器远程访问地址
...
const orderTagMap = { '-99': '作废', '-52': '已退货', '-51': '已取消', '-3': '退货中', '-2': '申请退货', '-1': '申请取消', 0: '待付款', 1: '待发货', 2: '已发货', 3: '已收货', 4: '已完成' }
// 订单物流状态
const orderDeliverStatusMap = { 0: '未开始', 1: '待发货', 2: '已发货', 3: '已收货' }
