...
export default {
  getRootPathAtTreeByKey, //获取当前节点的完整路径值（含父节点路径-递归，不包含子节点路径）
  setTreeNodeChildrenForUndefined, //针对element ui的cascade的BUG设计
  getNodeNumberFromTreeNode // 获取树形菜单的节点总数（递归）
}
